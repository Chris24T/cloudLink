...
function ButtonBar(props) {
    ...
    return (
        ...
        <div id="btnbar" style={{textAlign:"center", height:"15px"}} display="flex"  >
          
            <svg style={{left:"20px", position:"absolute"}} display="inline-block" height="20px" viewBox="0 0 16 16" className="bi bi-three-dots" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
