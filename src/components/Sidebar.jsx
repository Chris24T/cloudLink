...
function SideBar({actions}) {
    ...
    const {shutdown, refreshContent} = actions
    
    const {dirStack, allFiles, setDisplayFiles} = useContext(browserContentContext)
    ...
    return(
        ...
        <Link to="/"> 
        <div className="Sidebar_Button" onClick={ () => refreshContent()} > 
            
            <span className="tooltiptext">Refresh</span>   
            <svg style={{width:"100%", position:"relative", top:"15%"}} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
        ...
        <Link to="/">
            <div className="Sidebar_Button" onClick={() =>{}}>
             ...
             <Link to="/settings" styleclassName="navbtn">
                <div className="Sidebar_Button" style={{bottom:"0"}}> 
                <span className="tooltiptext">Settings</span>
                
                <svg style={{width:"100%", position:"relative", top:"15%"}} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
                ...
                <div className="Sidebar_Button" style={{bottom:"0", cursor:"pointer"}} onClick={ () => shutdown() }> 
                <span className="tooltiptext">Exit</span>
                <svg style={{width:"100%", position:"relative", top:"10%"}} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x-octagon" viewBox="0 0 16 16">
